...
# Funktion som omregner rektascension til radianer
def ra_hms_to_rad(s):
    """
    En vinkel målt langs Jordens ækvator kaldes "rektascension".
    Den måles normalt i timer, minutter og sekunder (hms).
    Denne funktion bruges til at omregne hms til radianer.
...
def dec_dms_to_rad(s):
    """
    En vinkel målt vinkelret væk fra ækvator kaldes "deklination"
    Den måles normalt i grader, bueminutter og buesekunder (dms).
    Denne funktion bruges til at omregne dms til radianer.
